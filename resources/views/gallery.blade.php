...
<body>
  ...
  <h1>My Gallery <br> in <br> BeSt 7th Anniversary</h1>
		<p class="center">"BeSt Digital on Progress"</p> 
    
	<div class="gallery">	
		<img src="{{ asset('images/tables/1/book-lamps.jpg')}}" type="thumbnail" alt="">
		<img src="{{ asset('images/tables/1/ceiling-lamp.jpg')}}" type="thumbnail" alt="">
		<img src="{{ asset('images/tables/1/cat.jpg')}}" type="thumbnail" alt="">
		<img src="{{ asset('images/tables/1/cat2.jpg')}}" type="thumbnail" alt="">
		
    
		<h2>Download Photos</h2>
		<ul>
			<li><a class="downloads coffe" href="#">Print in Coffe Printer</a></li>
			<li><a class="downloads jpg" href="#">Download as JPGs</a></li>
			<li><a class="downloads zip" href="#">Download as zip</a></li>
		</ul>
	</div>
