...
<body>
    ...
    <div class="container">
        <div class="row py-5">
          <div class="col-12">
            <table id="unvisited" class="table table-hover responsive nowrap" style="width:100%">
              <thead>
                <tr>
                  <th>Nama</th>
                  <th>No HP</th>
              ...
              <tbody>
                  @foreach ($unvisitedCollection as $unvisited)
                  <tr>
                        <td>
                          <a href="#">
                            <div class="d-flex align-items-center">
                              <div class="avatar avatar-pink mr-3"><i class="fas fa-user-times"></i></div>
            
                              <div class="">
                              <p class="font-weight-bold mb-0">{{$unvisited->nama}}</p>
                              </div>
                            </div>
                          </a>
                        </td>
