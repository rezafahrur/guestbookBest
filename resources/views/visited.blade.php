...
<body>
    ...
    <div class="container">
        <div class="row py-5">
          <div class="col-12">
            <table id="visited" class="table table-hover responsive nowrap" style="width:100%">
              <thead>
                <tr>
                  <th>Nama</th>
                  <th>No HP</th>
              ...
              <tbody>
                  @foreach ($visitedCollection as $visited)
                  <tr>
                        <td>
                          <a href="#">
                            <div class="d-flex align-items-center">
                              <div class="avatar avatar-blue mr-3"><i class="fas fa-user-check"></i></div>
            
                              <div class="">
                              <p class="font-weight-bold mb-0">{{$visited->nama}}</p>
                              </div>
                            </div>
                          </a>
                        </td>
